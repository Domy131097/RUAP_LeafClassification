...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private void predict(String predictData) {
        final Gson gson = new Gson();
        OkHttpClient client = new OkHttpClient().newBuilder()
                .build();
        MediaType mediaType = MediaType.parse("application/json");
        RequestBody body = RequestBody.create(mediaType, predictData);
        Request request = new Request.Builder()
                .url("https://ussouthcentral.services.azureml.net/workspaces/cab87e02deb6479eb9db9a8a87da3e80/services/3e57638d8c074ca19ad72391cf82d31b/execute?api-version=2.0&format=swagger")
                .method("POST", body)
                .addHeader("Content-Type", "application/json")
                .addHeader("Authorization", "Bearer ZEcwIMZSx+aXDwAnYoyM82hfhN5Him0sz6y1r5BY9wj4pZysaejbiOVEyox5ignv90sG9jeomxi3rxW0W5kHeQ==")
                .build();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                MainActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        scoredLabels.setText(output.ScoredLabels);
                        scoredProbabilities.setText(output.ScoredProbabilities);
                    }
                });
            }
    ...
    public void onClick(View v) {
        predict(selectedSample.getData());
    }
}